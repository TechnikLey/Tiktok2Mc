...
- **Automated test suite** — 285 tests covering API endpoints, plugin system, configuration, update checker, manifest validation, event bus, and smoke tests. CI workflow runs on every push and pull request.
