...
| `permissions` | Array | Granted API permissions: any of `"rcon"`, `"triggers"`, `"overlay"`, `"store"` (see [Hook API](./ch04-03-hook-api.md)); guarded calls without a matching permission are denied |
