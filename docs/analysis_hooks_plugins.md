...
>
> Weiterhin offen: nichts aus dieser Liste — E.7-Restthema „Prozess-Sandbox-Profile" nur bei Bedarf.
...
5. ~~J.3 nach Bedarf (Nr. 11–14)~~ → **Nr. 14 [✅ ERLEDIGT]** (generisches Event-Abo), **Nr. 12 [✅ ERLEDIGT]** (Katalog-Version + Delivery-Validierung), **Nr. 13 [✅ ERLEDIGT]** (Notification-Dispatcher), **Nr. 11 [✅ ERLEDIGT]** (Dashboard-UI-Erweiterungspunkte); E.7-Restthema „Prozess-Sandbox-Profile" nur bei Bedarf
