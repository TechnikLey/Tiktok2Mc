...
5. ~~J.3 nach Bedarf (Nr. 11–14)~~ → **Nr. 14 [✅ ERLEDIGT]** (generisches Event-Abo), **Nr. 12 [✅ ERLEDIGT]** (Katalog-Version + Delivery-Validierung); offen: Nr. 11 (Dashboard-UI-Erweiterungspunkte), Nr. 13 (Notification-Dispatcher); E.7-Restthema „Prozess-Sandbox-Profile" nur bei Bedarf
