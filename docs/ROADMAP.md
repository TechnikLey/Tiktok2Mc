...
The tool is nearly ready for its v1.0.0 release. All major features are implemented and working — the desktop GUI, plugin system, event reactions, installers for Windows and Linux, and auto-updates are all in place. The remaining work is about polish, testing, and documentation.
...
* **Channel Points** — a loyalty system where active viewers earn points and can spend them on commands
...
* **Minecraft server console** — manage your server directly from the GUI
* **Documentation refresh** — updating the user guide to cover the new GUI, event reactions, and setup wizard

## Planned Next

* **GUI integration tests** — automated testing for the dashboard and editors
* **Final v1.0.0 release** — last round of polish, compiled binaries, checksums, and release notes
