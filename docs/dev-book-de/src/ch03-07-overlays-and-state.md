...
Welche CSS-Variablen verfügbar sind, hängt vom `theme:`-Abschnitt der Plugin-Konfiguration ab — nur die dort definierten Farben werden als Variablen erzeugt (z. B. `--background`, `--text`, `--accent`).
