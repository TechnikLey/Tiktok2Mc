...
> `RandomTriggers` konfigurierbar. Mit `Mode: deny-all` werden nur die
...
In `config.yaml` unter `RandomTriggers` kann festgelegt werden, welche Trigger erlaubt oder blockiert werden:
