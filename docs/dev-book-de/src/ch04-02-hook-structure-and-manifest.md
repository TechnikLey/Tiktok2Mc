...
| `permissions` | Array | Gewährte API-Berechtigungen: `"rcon"`, `"triggers"`, `"overlay"`, `"store"`, `"network"` oder `"events"` (siehe [Hook-API](./ch04-03-hook-api.md)); bewachte Aufrufe ohne passende Berechtigung werden abgelehnt |
